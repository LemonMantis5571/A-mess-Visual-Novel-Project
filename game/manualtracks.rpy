...
init python:
    ...
    MrKitty_Afterdark = ost.soundtrack(
        name = "Afterdark",
        path = "audio/blezz1.mp3",
        priority = 2,
        author = "Mr. Kitty",
        description = "Ass the hours pass",
        cover_art = False,
        unlocked = renpy.seen_audio("audio/blezz1.mp3")
    )
    ost.manualDefineList.append(MrKitty_Afterdark)
